...
## Add unique ID to each data point - you will need them when doing spatial disaggregation and bootstrapping

foi_data_with_env_variables <- cbind(data_id = seq_len(nrow(foi_data_with_env_variables)), 
