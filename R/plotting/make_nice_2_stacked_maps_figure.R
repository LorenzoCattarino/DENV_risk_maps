make_nice_2_stacked_maps_figure <- function(parms,
  ...
  pred_map <- make_nice_map(bbox_df, countries_df, pred, pred_leg_val, parms, map_col, country_fill_col = "grey80", "FOI", LETTERS[1])
  ...
  sd_map <- make_nice_map(bbox_df, countries_df, sd, sd_leg_val, parms, map_col, country_fill_col = "grey80", "SD", LETTERS[2])
